...
namespace ver2UnitTests
{
    ...
    {
        // weryfikacja, czy po wywo³aniu metody `Fax` i w³¹czonej kopiarce w napisie pojawi siê s³owo `Fax`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOn()
        {
        ...
        // weryfikacja, czy po wywo³aniu metody `Fax` i wy³¹czonej kopiarce w napisie nie pojawi siê s³owo `Fax`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOff()
        {
