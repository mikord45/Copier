...
namespace ver2UnitTests
{
    ...
    public class UnitTestCopier
    {
        ...
        // weryfikacja, czy po wywo³aniu metody `Print`` w napisie NIE pojawia siê s³owo `Print`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
    ...
    {
        // weryfikacja, czy po wywo³aniu metody `Fax` i w³¹czonym urzadzeniu w napisie pojawi siê s³owo `Fax`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        ...
        // weryfikacja, czy po wywo³aniu metody `Fax` i wy³¹czonynm urz¹dzenieu w napisie nie pojawi siê s³owo `Fax`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void Copier_ScanAndPrint_DeviceOff()
        {
